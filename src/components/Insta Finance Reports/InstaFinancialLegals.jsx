...
const InstaFinancialLegals = () => {
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post(
          `${import.meta.env.VITE_APP_BACKEND_URL}/financial/legal/order`,
          {
  ...
  const handleStatusCheck = async (cin_number, orderid, insta_api_key) => {
    try {
      setLoading(true);
      const response = await axios.post(
        `${import.meta.env.VITE_APP_BACKEND_URL}/financial/legal/status`,
        {
          cin_number,
          orderid,
          insta_api_key,
...
export default InstaFinancialLegals;
